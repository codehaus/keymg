...
public interface SymKeyConstants {
    ...
    public enum QNameConstants {
        ANY_QNAME(EKMI_NAMESPACE_URI, SymKeyConstants.ANY), KEYUSEPOLICY_QNAME(EKMI_NAMESPACE_URI,
                SymKeyConstants.KEY_USE_POLICY), SYMKEY_QNAME(EKMI_NAMESPACE_URI, SymKeyConstants.SYMKEY);
